...
import { HiArrowSmRight, HiChartPie, HiInbox, HiShoppingBag, HiTable, HiUser, HiViewBoards,HiArrowSmLeft } from "react-icons/hi";
  ...
  return (
      ...
      <Sidebar.Items>
        ...
        {currentUser.isAdmin && ( <Link to='/dashboard?tab=dash' >
          <Sidebar.Item as={'div'}  active={tab==='dash'} icon={HiViewBoards} >
           Dashboard
          </Sidebar.Item>
          </Link>)}
        
          <Link to='/dashboard?tab=profile' >
          <Sidebar.Item as={'div'}  active={tab==='profile'} icon={HiViewBoards} label={currentUser.isAdmin?'Admin':'User'}  labelColor="dark">
           Profile
          </Sidebar.Item>
          </Link>
          {currentUser.isAdmin && ( <Link to='/dashboard?tab=posts' >
          <Sidebar.Item as={'div'}  active={tab==='posts'} icon={HiViewBoards} >
           Posts
          </Sidebar.Item>
          </Link>)}
          {currentUser.isAdmin && ( <Link to='/dashboard?tab=users' >
          <Sidebar.Item as={'div'}  active={tab==='users'} icon={HiViewBoards} >
           Users
          </Sidebar.Item>
          </Link>)}
          {currentUser.isAdmin && ( <Link to='/dashboard?tab=comments' >
          <Sidebar.Item as={'div'}  active={tab==='comments'} icon={HiViewBoards} >
           Comments
          </Sidebar.Item>
          </Link>)}
